...
export const leadContent = {
	...
	paragraph: `${schoolName} designs its programs to cover full-stack JavaScript, providing a foundation for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving
		? ' and cost of living'
...
export const programMaxText =
	"Choose the loan amount that works best for you. Borrow up to $10,960 for Austin Coding Academy's Full-Stack JavaScript tuition.";
