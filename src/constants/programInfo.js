...
export const faq = {
  ...
  loanRange: [
    ...
    {
      programName: "Full Stack Web Development Online - Part Time",
      maxAmount: "$10,960",
      col: false,
      colAmount: "$10,000",
    },
...
export const leadContent = {
  ...
  paragraph: `${schoolName} designs its programs to cover full-stack JavaScript, providing a foundation for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${
...
export const threeStepCardText = {
  ...
  step2: {
    ...
    text:
      "Choose between the Full-Stack JavaScript program, Full Stack Web Development Online Part Time program, or Full Stack Web Development Online Full Time program.",
  },
...
export const hubspotFormId = "8e6f7b98-76d4-41fd-a8a4-d1166019ada4" // create Hubspot form, get form id after publishing

export const selectAProgram = "select_a_austincodingacademy_program" // update school name to match form field on Hubspot, *** change to "program_name" if only one program ***"
...
export const programLoanInfo = [
  // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
  {
    ...
    url: "https://my.skills.fund/application?lenderCode=SKACFSJ18",
    loanInfo: {
  ...
  {
    name: "Full Stack Web Development Online - Full Time",
    url: "https://my.skills.fund/application?lenderCode=SKACFSWDFT20",
    loanInfo: {
      // match loanInfo in first metro below
      maxLoanAmt: 20960,
      loanTerm36: true,
...
export const programMaxText =
  "Choose the loan amount that works best for you. Borrow up to $10,960 for Austin Coding Academy's Full-Stack JavaScript tuition, up to $10,960 for the Full Stack Web Development Online - Part Time program tuition, or up to $10,960 for the Full Stack Web Development Online - Full Time program tuition and up to $10,000 for living expenses."
